...
(setq org-agenda-files (list "~/Documents/working/mygtd.org"
                             "~/Documents/working/inbox.org"))

(setq org-capture-templates
  '(("t" "TODO" entry (file+headline "~/Documents/working/mygtd.org" "inbox")
         "* %?\n ")))

(global-set-key "\C-cm" 'org-capture)